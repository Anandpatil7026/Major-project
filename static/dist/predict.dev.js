...
var inputGlucose = document.getElementById('avgGlucoseLevel'); //var inputHBA1C = document.getElementById('hba1c');
//var inputCholesterol = document.getElementById('cholesterol');
// Get reference to the form

var form = document.querySelector('form'); // Function to validate name input
...
function validateGlucose() {
  var glucose = inputGlucose.value;
...
form.addEventListener('submit', function (event) {
  ...
  inputGlucose.nextElementSibling.innerHTML = ''; // Validate form fields
...
//# sourceMappingURL=predict.dev.js.map
